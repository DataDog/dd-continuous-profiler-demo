...
- Pre-computes CREDITS_BY_MOVIE_ID dict for O(1) credit lookups
- Pre-computes MOVIES_WITH_CREDITS list on startup
- REQUEST_METRICS dict (bounded)
...
MOVIES_API_PORT = int(os.environ.get("MOVIES_API_PORT", "8081"))

app = Flask(__name__)

REQUEST_METRICS: dict = {}

# Lazily initialised pre-computed caches (set on first request or at startup)
