...
- **leaky** (`9082`) — intentional memory leak: every request appends a `Metrics` object containing 256 KiB to an unbounded list, visible in the Datadog heap profiler (OOM ~15 min at 512 Mi limit)
